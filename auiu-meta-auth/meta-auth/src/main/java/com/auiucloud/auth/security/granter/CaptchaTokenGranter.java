package com.auiucloud.auth.security.granter;
...
public class CaptchaTokenGranter extends AbstractTokenGranter {
    ...
    protected OAuth2Authentication getOAuth2Authentication(ClientDetails client, TokenRequest tokenRequest) {
        ...
        // 增加验证码判断
        String key = request.getHeader(RedisKeyConstant.DEVICE_HEADER_KEY);
        String code = request.getHeader(RedisKeyConstant.DEVICE_HEADER_CODE);
