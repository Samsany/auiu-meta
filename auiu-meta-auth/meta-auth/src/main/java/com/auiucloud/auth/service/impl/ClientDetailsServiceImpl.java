...
public class ClientDetailsServiceImpl extends JdbcClientDetailsService {
    ...
    public ClientDetails loadClientByClientId(String clientId) throws InvalidClientException {
        ClientDetails clientDetails = (ClientDetails) redisService.get(RedisKeyConstant.cacheClientKey(clientId));
    ...
    private ClientDetails getCacheClient(String clientId) {
        ...
        try {
            ...
            if (ObjectUtil.isNotEmpty(clientDetails)) {
                redisService.set(RedisKeyConstant.cacheClientKey(clientId), clientDetails);
