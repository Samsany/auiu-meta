...
public abstract class AbstractValidateCodeProcessor<C extends Captcha> implements CaptchaService {
    ...
    public void validate() {
        ...
        String key = RequestHolder.getHttpServletRequestHeader(RedisKeyConstant.DEVICE_HEADER_KEY);
        String code = RequestHolder.getHttpServletRequestHeader(RedisKeyConstant.DEVICE_HEADER_CODE);
