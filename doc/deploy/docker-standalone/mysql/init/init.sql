...
VALUES (1, 'mate.yaml', 'DEFAULT_GROUP',
        '#服务器配置\nserver:\n  undertow:\n    # 设置IO线程数, 它主要执行非阻塞的任务,它们会负责多个连接, 默认设置每个CPU核心一个线程\n    io-threads: 4\n    # 阻塞任务线程池, 当执行类似servlet请求阻塞操作, undertow会从这个线程池中取得线程,它的值设置取决于系统的负载\n    worker-threads: 20\n    # 以下的配置会影响buffer,这些buffer会用于服务器连接的IO操作,有点类似netty的池化内存管理\n    buffer-size: 1024\n    # 是否分配的直接内存\n    direct-buffers: true\n\n#spring配置\nspring:\n  devtools:\n    restart:\n      log-condition-evaluation-delta: false\n    livereload:\n      port: 23333\n  main:\n    allow-bean-definition-overriding: true\n  #修改文件上传限制\n  servlet:\n    multipart:\n      # 文件最大限制\n      max-file-size: 1024MB\n      # 请求最大限制\n      max-request-size: 1024MB\n      enabled: true\n      # 设置文件缓存的临界点,超过则先保存到临时目录,默认为0,所有文件都会进行缓存\n      file-size-threshold: 0\n\n#feign配置\nfeign:\n  hystrix:\n    enabled: true\n    #sentinel:\n    #enabled: true\n  okhttp:\n    enabled: true\n  httpclient:\n    enabled: false\n#对外暴露端口\nmanagement:\n  endpoints:\n    web:\n      exposure:\n        include: \"*\"\n  endpoint:\n    health:\n      show-details: always\n#knife4j 2.0.6+配置参数\nknife4j:\n  enable: true\n  setting:\n    enableReloadCacheParameter: true',
        'd6e93e6ffb1f8fa3e65661d817300b9d', '2021-04-12 02:24:06', '2021-04-12 02:24:06', NULL, '172.18.0.1', '', '',
        NULL, NULL, NULL, 'yaml', NULL);
INSERT INTO `config_info`
VALUES (2, 'mate-local.yaml', 'DEFAULT_GROUP',
        ...
        '263f7d2c658daa294c64045db191db39', '2021-04-12 02:24:06', '2021-04-12 02:24:36', NULL, '172.18.0.1', '', '',
        '', '', '', 'yaml', '');
INSERT INTO `config_info`
VALUES (3, 'mate-dynamic-routes.yaml', 'DEFAULT_GROUP',
        'routes:\n  # mate-uaa\n  - id: mate-uaa\n    predicates:\n      - name: Path\n        args:\n          _genkey_0: /mate-uaa/**\n    filters: []\n    uri: lb://mate-uaa\n    order: 0\n  # mate-system\n  - id: mate-system\n    predicates:\n      - name: Path\n        args:\n          _genkey_0: /mate-system/**\n    filters:\n      - name: RequestRateLimiter\n        args:\n          # 限流策略\n          key-resolver: \'#{@remoteAddrKeyResolver}\'\n          # 令牌桶每秒填充率\n          redis-rate-limiter.burstCapacity: 20\n          # 令牌桶容量\n          redis-rate-limiter.replenishRate: 20\n    uri: lb://mate-system\n    order: 0\n  # mate-component\n  - id: mate-component\n    predicates:\n      - name: Path\n        args:\n          _genkey_0: /mate-component/**\n    filters: []\n    uri: lb://mate-component\n    order: 0\n  # mate-code\n  - id: mate-code\n    predicates:\n      - name: Path\n        args:\n          _genkey_0: /mate-code/**\n    filters: []\n    uri: lb://mate-code\n    order: 0',
        '9684dca44db931eff2a075958f32e27a', '2021-04-12 02:24:06', '2021-04-12 02:24:06', NULL, '172.18.0.1', '', '',
        NULL, NULL, NULL, 'yaml', NULL);
COMMIT;
