...
public class RestTemplateUtil {
    ...
    public static ResponseEntity<String> httpGetHeaders(String url) {
        ...
        return restTemplateUtil.restTemplate.exchange(url, HttpMethod.GET, entity, String.class);
    }
    ...
    public static <T> ResponseEntity<T> get(String url, Class<T> responseType, Object... uriVariables)
        ...
        return restTemplateUtil.restTemplate.getForEntity(url, responseType, uriVariables);
    }
    ...
    public static <T> ResponseEntity<T> post(String url, Object requestBody, Class<T> responseType)
            throws RestClientException {
        return restTemplateUtil.restTemplate.postForEntity(url, requestBody, responseType);
    }
