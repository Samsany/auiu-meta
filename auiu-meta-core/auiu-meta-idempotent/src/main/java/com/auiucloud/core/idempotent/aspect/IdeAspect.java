package com.auiucloud.core.idempotent.aspect;

import cn.hutool.core.util.StrUtil;
import com.alibaba.fastjson2.JSON;
import com.alibaba.fastjson2.JSONObject;
import com.auiucloud.core.idempotent.annotation.Ide;
import com.auiucloud.core.idempotent.enums.IdeTypeEnum;
import com.auiucloud.core.idempotent.exception.IdeException;
...
public class IdeAspect extends BaseAspect {
    ...
    @Pointcut("@annotation(com.auiucloud.core.idempotent.annotation.Ide)")
