package com.auiucloud.core.sentinel.feign;
 ...
 * @author dries
 **/
public final class MetaFeignSentinel {

    private MetaFeignSentinel() {

    }

    public static MetaFeignSentinel.Builder builder() {
    ...
    public static final class Builder extends Feign.Builder implements ApplicationContextAware {
        ...
        @Override
        public MetaFeignSentinel.Builder contract(Contract contract) {
