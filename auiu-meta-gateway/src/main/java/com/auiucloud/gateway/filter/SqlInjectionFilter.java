...
import com.auiucloud.core.common.utils.sql.SqlInjectionUtil;
import com.auiucloud.gateway.util.WebFluxUtil;
...
public class SqlInjectionFilter implements GlobalFilter, Ordered {
    ...
    private Mono<Void> sqlInjectionResponse(ServerWebExchange exchange, URI uri) {
        ...
        return WebFluxUtil.writeJsonResponse(exchange.getResponse(), ApiResult.fail(403, "疑似SQL注入请求"));
    }
